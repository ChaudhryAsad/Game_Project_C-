...
{
    delete food;
    delete snake;/* 33 : Dynamic memory removing */
}

//--------------------------------------------------------------------------
//Hier worden old en high score getelt en toegevoegd,
//Snake krijgt de score en hangt van de score af hoe groot het word.
